...
export async function getAllVarsToMqtt() {

    const url = `${urlBase}/modbusdata/getvarstomqtt`;
...
export async function registerVarToMqtt(name) {

  const url = `${urlBase}/modbusdata/registervartomqtt`;
...
export async function deleteVarToMqtt (name) {

  const url = `${urlBase}/modbusdata/deletevartomqttbyname`;
